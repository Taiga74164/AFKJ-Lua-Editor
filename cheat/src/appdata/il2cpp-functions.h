...
DO_APP_FUNC(0x0178B0C0, void, GameMain_Update, (void/*GameMain*/* __this, MethodInfo* method));
...
DO_APP_FUNC(0x033BF6D0, Byte__Array*, Encoding_GetBytes_2, (Encoding* __this, String* s, MethodInfo* method));
DO_APP_FUNC_METHODINFO(0x05C06578, Encoding_GetBytes_2__MethodInfo);
...
DO_APP_FUNC(0x014EB950, void, LuaState_DoString, (LuaState* __this, String* chunk, String* chunkName, MethodInfo* method));
DO_APP_FUNC(0x0208AF60, Object*, LuaState_DoString_1, (LuaState* __this, String* chunk, String* chunkName, MethodInfo* method));
DO_APP_FUNC(0x014F4FD0, void, LuaState_LuaLoadBuffer, (LuaState* __this, Byte__Array* buffer, String* chunkName, MethodInfo* method));
DO_APP_FUNC(0x01501FF0, int32_t, LuaStatePtr_LuaLoadBuffer, (LuaStatePtr* __this, Byte__Array* buff, int32_t size, String* name, MethodInfo* method));
DO_APP_FUNC(0x0208F9A0, Object*, LuaState_LuaLoadBuffer_1, (LuaState* __this, Byte__Array* buffer, String* chunkName, MethodInfo* method));
...
DO_APP_FUNC(0x015C8890, LuaManager*, LuaManager_get_Instance, (MethodInfo* method));